...
pub const KERNEL_ERRORS: [(u32, &str); 71] = [
    ...
    (ERR_PROLOGUE_MISMATCH_OF_INPUT_NOTES_COMMITMENT_FROM_ADVICE_DATA_AND_KERNEL_INPUTS, stringify!(ERR_PROLOGUE_CANNOT_COMPUTE_MATCHING_NULLIFIER_COMMITMENT_USING_INPUT_NOTE_DATA)),
